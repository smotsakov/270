...
var block_logo = '<div id="rad_block_logo"><img src="'+rad_plogo+'" border="0" id="rad_logo" alt="РѕРЅР»Р°Р№РЅ СЂР°РґРёРѕ"></a></div>';
...
document.getElementById('radiobells_container').innerHTML = '<div style="background-color: '+rad_backcolor+'opacity: 0; width: '+style_rad_width+';" id="rad_player"><div style="height: 28px;">' + block_play + block_select + block_volume + block_logo +'</div></div>';

var g_rad_player_width = document.getElementById("rad_player").clientWidth;

if (g_rad_player_width<=430){
    document.getElementById('rad_player').style.height = '50px';
    document.getElementById('rad_block_logo').style.display="none";
